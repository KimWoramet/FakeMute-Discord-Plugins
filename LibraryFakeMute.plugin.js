...
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    module.exports = {
        id: "9",
        name: "Libraby FAKEMUTE",
        author: "KimWoramet",
        version: "0.0.1",
        description: "on every time for use, เปิดตลอดเพื่อใช้",
        source: "https://www.facebook.com/KimWoramet555/",
        changelog: [
    ...
    */
    ...
    class Popouts {
        ...
        static dispose() {
            ...
            const container = document.querySelector(".LibrabyPLUGPopoutsRenderer");
            const layerContainer = document.querySelector("#LibrabyPLUGPopouts");
    ...
    class PluginLibrary extends _structs_plugin__WEBPACK_IMPORTED_MODULE_2__["default"] {
        ...
        _reloadPlugins() {
            const list = BdApi.Plugins.getAll().reduce((acc, val) => {
                ...
                if (name === "LibrabyPLUG") return acc;
                acc.push(name);
                return acc;
            }, []);
    ...
    window.LibrabyPLUG = PluginLibrary;
    /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PluginLibrary);
    
    })();
    
    module.exports.LibrabyPLUG = __webpack_exports__["default"];
    /******/ })()
    ;
    /*@end@*/